    ...
    <div class="table-edit-div">
        ...
        <table class="table-edit">
            <tr>
                ...
                <td>
					<input type="text" id="roleName" name="roleName" maxlength="15">
                 	<div class="error-msg"></div>
                </td>
                <td>排序</td>
                <td><input type="text" id="roleOrder" name="roleOrder"><div class="error-msg"></div></td>  
            </tr>
            <tr>
				<td>角色描述</td>
				<td colspan="3" style="line-height:25px;padding-top:10px;padding-bottom:10px;">
					<textarea name="roleDesc" id="roleDesc" maxlength="256"></textarea>
