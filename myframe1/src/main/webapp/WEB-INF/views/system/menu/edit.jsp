    ...
    <div class="table-edit-div">
        ...
        <table class="table-edit">
            ...
            <tr>
                ...
                <td><input type="text" id="menuName" name="menuName" value="${sMenu.menuName}" maxlength="16"><div class="error-msg"></div></td>
            </tr>
            <tr>
                <td>排序</td>
                <td><input type="text" id="menuOrder" name="menuOrder" value="${sMenu.menuOrder}"><div class="error-msg"></div></td>
            </tr>
            <c:if test="${sMenuP.menuLevel!=2}">
            <tr>
                <td>菜单URL</td>
                <td><input type="text" id="menuUrl" name="menuUrl" value="${sMenu.menuUrl}"><div class="error-msg"></div></td>
            </tr>
            </c:if>
            <tr>
